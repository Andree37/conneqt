        ...
        <FadeIn className="lg:order-last">
            <form>
                ...
                <div className="isolate mt-6 w-96 -space-y-px rounded-2xl bg-white/50">
                    <TextInput
                        onChange={(val: { target: { value: string } }) => handleChange('name', val.target.value)}
                        label="Name"
                        name="name"
                        autoComplete="name"
                        value={form.name}
                    ...
                    <TextInput
                        ...
                        name="email"
                        autoComplete="email"
                        onChange={(val: { target: { value: string } }) => handleChange('email', val.target.value)}
                        value={form.email}
                    />
                    <TextInput
                        onChange={(val: { target: { value: string } }) => handleChange('phone', val.target.value)}
                        label="Phone"
                        type="tel"
                        name="phone"
                        autoComplete="tel"
